...
| **Storage** | EBS `gp3` SSD | 250 GB of storage. |
| **Networking** | NAT Gateway, Load Balancer | NAT Gateway, Load Balancer, data transfer, and associated network consumption. |
...
| **Storage** | Managed Disk (Premium SSD) | 250 GB of storage. |
| **Networking** | NAT Gateway, Azure Load Balancer | NAT Gateway, Load Balancer, data transfer, and associated network consumption. |
...
| **Storage** | Persistent Disk SSD | 250 GB of storage. |
| **Networking** | Cloud NAT, Cloud Load Balancing | NAT Gateway, Load Balancer, data transfer, and associated network consumption. |
